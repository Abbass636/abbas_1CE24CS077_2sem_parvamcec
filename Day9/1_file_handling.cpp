...
int main()
{
    // creating abject for writing files
    ofstream fout;

    // opening file in write mode
    fout.open("1_file_handling.txt"); // it will open the file in write mode if ythe file is not present in the "cwd" it will create a new file with specified name.
